  ...
  <body>
    <header>
      ...
      <ul id="nav-mobile" class="side-nav fixed">
		...
		<li class="bold"><center><p class="flow-text">Warna Warni</p></li><br>
...
<center>
		<div class="container">
		<div class="z-depth-1 grey lighten-4 row" style="display: inline-block; height : 1190px; width:750px; border: 1px solid #EEE;">
		<br>

			<div class="row">
            <div class="card-image" align="center">
				<img src="../images/4.jpg" style="width:400px ; height:450px">
				<span class="card-title"></span>
            </div>
			</div>

			<h5 class="col s12 light center" style="color : #3e2723"><b>Halaman Terakhir</b></h5>	
			
			<br><br>

				<blockquote style="color:grey">Penulis : Yudhi Heribowo</blockquote>
				<blockquote style="color:grey">Judul Buku : Halaman Terakhir</blockquote>
                <blockquote style="color:grey">Harga : Rp180.000,00</blockquote>
                <blockquote style="color:brown">Hoegeng sedang diuji. Dua kasus besar mencuat, mencuri perhatiannya yang kala itu menjabat sebagai Kapolri. Dua kasus yang membuatnya terbentur tembok raksasa dan menguji integritasnya sebagai seorang polisi.
...
Kasus kedua adalah penyelundupan mobil mewah. Keterlibatan seorang putra pejabat tinggi di tanah air membuat kasus ini sulit menyentuh dasar masalahnya. Seolah para pelaku telah mengantisipasi langkah Hoegeng dan anak buahnya, semakin dalam penyelidikan, semakin bukti itu menghilang.</blockquote>
				<br>
				<a href="../daftarbukuuser.php" class='col s4 btn btn-large waves-effect purple' style="margin-left : 17.5rem">Kembali</a>       
	    </div>
		</div>
</center>
