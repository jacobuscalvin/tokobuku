...
<center>
		<div class="container">
		<div class="z-depth-1 grey lighten-4 row" style="display: inline-block; height : 1150px; width:750px; border: 1px solid #EEE;">
		<br>

			<div class="row">
            <div class="card-image" align="center">
				<img src="../images/9.jpg" style="width:400px ; height:450px">
				<span class="card-title"></span>
            </div>
			</div>

			<h5 class="col s12 light center" style="color : #3e2723"><b>Diary of a Wimpy Kid - The Third Wheel</b></h5>	
			
			<br><br>

				<blockquote style="color:grey">Penulis : Jeff Kinney</blockquote>
				<blockquote style="color:grey">Judul Buku : Diary of a Wimpy Kid - The Third Wheel</blockquote>
                <blockquote style="color:grey">Harga : Rp50.000,00</blockquote>
                <blockquote style="color:brown">
Hari valentine di sekolah menengah Greg telah berubah dunianya terbalik. Seperti Greg mengacak untuk menemukan kencan, dia khawatir dia akan ditinggalkan dalam dingin pada malam besar. sahabatnya, Rowley, tidak memiliki prospek apapun baik, tapi itu penghiburan kecil.

Twist tak terduga memberikan Greg mitra untuk tari dan daun Rowley orang aneh. Tapi banyak yang bisa terjadi dalam satu malam, dan pada akhirnya, Anda tidak pernah tahu siapa yang akan menjadi beruntung dalam cinta.</blockquote>
				<br>
