...
<center>
		<div class="container">
		<div class="z-depth-1 grey lighten-4 row" style="display: inline-block; height : 1140px; width:750px; border: 1px solid #EEE;">
		<br>

			<div class="row">
            <div class="card-image" align="center">
				<img src="../images/6.jpg" style="width:400px ; height:450px">
				<span class="card-title"></span>
            </div>
			</div>

			<h5 class="col s12 light center" style="color : #3e2723"><b>Kugapai Dia dengan Doa</b></h5>	
			
			<br><br>

				<blockquote style="color:grey">Penulis : Saba Azzam</blockquote>
				<blockquote style="color:grey">Judul Buku : Kugapai Dia dengan Doa</blockquote>
                <blockquote style="color:grey">Harga : Rp90.000,00</blockquote>
                <blockquote style="color:brown">Bermimpi dan berambisi hanya ada pada manusia siluman setengah bule di Kediri. Tak lebih semua perkataannya mengatasnamakan mimpi untuk segala hal. Kata-katanya tidak banyak hanya tatapannya yang menyakitkan.
Tak ada kata cinta yang melintasi jalannya tapi siapa tahu jika satu mimpi terlanjur jatuh hanya karena satu orang dan berlanjut dengan cerita lain. Tetapi dia berbuah hasil setelah sekian lama perjuangan panjang. Zhafira Alfarani. Kembang desa keras kepala.</blockquote>
				<br>
