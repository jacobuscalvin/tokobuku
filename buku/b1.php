    ...
    <main><div class="section no-pad-bot" id="index-banner">
        <div class="container">
          ...
          <div class='row center'>
            <h4 class ="header col s12 light center">Warna Warni Perpustakaan</h4>
          </div>
