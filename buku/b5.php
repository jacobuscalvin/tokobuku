...
<center>
		<div class="container">
		<div class="z-depth-1 grey lighten-4 row" style="display: inline-block; height : 1200px; width:750px; border: 1px solid #EEE;">
		<br>

			<div class="row">
            <div class="card-image" align="center">
				<img src="../images/8.jpg" style="width:400px ; height:450px">
				<span class="card-title"></span>
            </div>
			</div>

			<h5 class="col s12 light center" style="color : #3e2723"><b>Sweet Sonata</b></h5>	
			
			<br><br>

				<blockquote style="color:grey">Penulis : Karumi Iyagi</blockquote>
				<blockquote style="color:grey">Judul Buku : Sweet Sonata</blockquote>
                <blockquote style="color:grey">Harga : Rp140.000,00</blockquote>
                <blockquote style="color:brown">Shin Hye terbelalak saat melihat siapa yang harus ia rias. Rasanya ia ingin berbalik pergi saat itu juga. Tapi sudah terlambat, ia tak bisa mundur lagi. Selain itu ia sangat membutuhkan pekerjaan ini. Tepatnya, ia sangat membutuhkan honor dari pekerjaan ini yang jumlahnya lumayan besar. Jauh lebih besar dari gajinya dulu saat bekerja di salon kecantikan.
...
Pemuda  itu mengangkat wajahnya dan melihat ke arah cermin.</blockquote>
				<br>
